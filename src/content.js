        ...
        tabs: [
            {
                ...
                text: `            
                    ...
                    <ul>
                        ...
                        (перекрытия, стены, стропильная система) (http://ultralam.com/ru/продукция-ультралам/лвл-брус/)
                        </li>
                        <li><span>Теплоизоляция</span> 200 мм (перекрытия, наружные стены, стропильная система) минераловатными
                         плитами «ROCKWOOL»  ЛАЙТ БАТС (http://www.rockwool.ru/products/lajt-batts/)
                         </li>
                        <li><span>Гидроветрозащитная диффузионная мембрана</span>  «DELTA®-VENT N PLUS» производителя Dörken GmbH
                         & Co. KG  - Германия). Импортный продукт. (http://www.doerken.com/ru/products/pitched-roof/delta-vent-n.php)
                         </li>
                        <li><span>Мансардные окна</span> и их комбинации «VELUX» (Дания). Импортный продукт.</li>
                        ...
                        <li>Варианты <span>внутренней отделки</span> и  прайс лист  инженерных коммуникаций – по запросу.</li>
                    </ul>
            ...
            },
            {
                ...
                text: `
                    ...
                    <ul>
                        ...
                        <li><span>Клик-фальцевая</span> кровля «Grand Line» </li>
                        <li>Пластиковые двухкамерные окна-двери, окна и широкоформатные раздвижные портальные двери.
                        </li>
                        <li><span>Фальцевая кровля</span> «Ruukki»  Classic D в покрытиии Pural Matt (Финляндия). Импортный продукт.</li>
                        <li>Мансардные окна и их комбинации «VELUX» (Дания). Импортный продукт.</li>
                        <li><span>Фасады</span> – планкен из массива сосны, с шириной ламелей 45 мм. Производственно окрашенный в 
                    соответствии с технологией производителя ЛКМ» «TЕKNOS»  (Финляндия). Импортный продукт. 
                    (http://www.wood.teknos.ru)
                         </li>
                        <li>Черновая конструкционная  (оболочка жёсткости) <span>интерьерная отделка</span> плитными материалами – 
                    фибролитовые плиты «Green Board» (GB1050 http://g-b-t.ru/product/grinbord-green-board-gb1050)у.</li>
                    </ul>
